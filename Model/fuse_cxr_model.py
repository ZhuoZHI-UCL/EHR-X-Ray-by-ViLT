...
class fuse_cxr_model(pl.LightningModule):
    def __init__(self, config):
        ...
        #-------------------------------模型权重加载与初始化--------------------------------#
        #是否加载预训练权重,注意，这里的transformer要加载的是fuse_cxr的权重，而不是Vit的权重
    ...
    def on_train_start(self):
        ...
        files_to_copy = {
            'fuse_config.py': '/scratch/uceezzz/Project/Mis_mul/Soluation_mis/Config/fuse_cxr_config.py',
            'Extract_data_1.py': '/scratch/uceezzz/Project/Mis_mul/Soluation_mis/Dataloader/Extract_data_1.py',
            'fuse_model.py': '/scratch/uceezzz/Project/Mis_mul/Soluation_mis/Model/fuse_cxr_model.py'
        }
